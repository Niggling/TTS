...
# dataset_config = BaseDatasetConfig(formatter="vctk", meta_file_train="", path="C:/Code/Coqui/recipes/ljspeech/LJSpeech-1.1/")
dataset_config = BaseDatasetConfig(formatter="ljspeech", meta_file_train="metadata.csv", path=os.path.join(output_path, "C:/Code/Coqui/recipes/ljspeech/LJSpeech-1.1/"))
